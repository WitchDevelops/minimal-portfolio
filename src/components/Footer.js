      ...
      <div className={styles.footer__wrapper}>
        <div className={styles.footer__Ctn}>
          ...
          <div className={styles.footer__icons}>
            <a href="https://github.com/" target="_blank" rel="noreferrer" className={styles.footer__icon}><svg
              xmlns="http://www.w3.org/2000/svg"
              height="24px"
              viewBox="0 0 496 512"
            >
            ...
            <a href="https://twitter.com/" target="_blank" rel="noreferrer" className={styles.footer__icon}><svg
              xmlns="http://www.w3.org/2000/svg"
              height="24px"
              viewBox="0 0 512 512"
            >
            ...
            <a href="https://www.linkedin.com/" target="_blank" rel="noreferrer" className={styles.footer__icon}><svg
              xmlns="http://www.w3.org/2000/svg"
              height="24px"
              viewBox="0 0 448 512"
            >
